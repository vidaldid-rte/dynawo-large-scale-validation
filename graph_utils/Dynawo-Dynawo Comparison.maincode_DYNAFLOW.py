# Note: this variant is for *DynaFlow* cases. The differences are
# mainly in the type of variables that are expected (phase-shifter
# steps and DC link vars; no RST vars).
import os
import pandas as pd
import numpy as np
...
delta.loc[delta.vars.str.contains("_step_value"), "typevar"] = "T"
delta.loc[delta.vars.str.contains("_PGen"), "typevar"] = "P"
delta.loc[delta.vars.str.contains("_QGen"), "typevar"] = "Q"
delta.loc[delta.vars.str.contains("_P1"), "typevar"] = "P"
delta.loc[delta.vars.str.contains("_P2"), "typevar"] = "P"
delta.loc[delta.vars.str.contains("_Q1"), "typevar"] = "Q"
delta.loc[delta.vars.str.contains("_Q2"), "typevar"] = "Q"
d_threshold = {"V": V_THRESH, "P": P_THRESH, "Q": Q_THRESH, "T": TAP_THRESH}
...
mask_n = ["Upu_value" in x for x in delta.vars]
df = delta[mask_n]
