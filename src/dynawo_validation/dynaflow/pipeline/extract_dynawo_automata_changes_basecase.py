...
def main():
    ...
    df_dynawo_ratioTapChanger_basecase.to_csv(save_path+"df_dynawo_ratioTapChanger_basecase.csv", sep=";")
    ...
    df_dynawo_phaseTapChanger_basecase.to_csv(save_path+"df_dynawo_phaseTapChanger_basecase.csv", sep=";")
    ...
    df_dynawo_branch_basecase_bus1.to_csv(save_path+"df_dynawo_branch_basecase_bus1.csv", sep=";")
    ...
    df_dynawo_branch_basecase_bus2.to_csv(save_path+"df_dynawo_branch_basecase_bus2.csv", sep=";")
