...
\author{
  ...
  \IEEEauthorblockA{
    \IEEEauthorrefmark{1}Aplicaciones en Informática Avanzada SL, Avda. de la Torre Blanca, 57, 08172 Sant Cugat del Vallès, Spain\\
    \{marinjl, gaitanv, omsg\}@aia.es
  }
  \IEEEauthorblockA{
    \IEEEauthorrefmark{2}R\&D department, RTE Réseau de Transport d’Electricité, Paris, France\\
    \{adrien.guironnet, marco.chiaramello, quentin.cossart\}@rte-france.com
  }
}
