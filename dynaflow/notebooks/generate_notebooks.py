...
def main():
    ...
    for line in fin:
        ...
        if "CHANGE_0" in line:
            fout.write(line.replace("CHANGE_0", case_dir))
        elif "CHANGE_1" in line:
            fout.write(line.replace("CHANGE_1", base_case))
        elif "CHANGE_2" in line:
            fout.write(line.replace("CHANGE_2", contg_type))
        elif "CHANGE_3" in line:
            fout.write(line.replace("CHANGE_3", dwo_dwo))
        else:
            fout.write(line)
